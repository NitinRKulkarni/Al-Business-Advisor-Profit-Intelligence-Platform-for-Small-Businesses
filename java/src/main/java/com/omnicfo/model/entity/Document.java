...
public class Document {
    ...
    /**
     * Filesystem/object-storage location of the stored PDF. The Python AI
     * service reads this (or {@link #fileData}) to retrieve the original file
     * by document_id. Kept nullable so either storage strategy can be used.
     */
    @Column(name = "file_path")
    private String filePath;

    /**
     * Optional in-DB copy of the raw file bytes (simple for local dev). Prefer
     * {@link #filePath} at scale.
     */
